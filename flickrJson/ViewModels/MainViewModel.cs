    ...
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        public void LoadData()
        {
            ...
            */
            ...
            //https://api.flickr.com/services/rest/?method=flickr.photosets.getPhotos&api_key=b8ddd68cffd21f1ed5001dccf258801c&photoset_id=72157624736295465&format=json&nojsoncallback=1&api_sig=ac3da2bea26c91836c0bc865a8b472ad
            Uri uri = new Uri("https://api.flickr.com/services/rest/?method=flickr.photosets.getPhotos&api_key=b79c787dc2f9f079cca1dbc2746e83c8&photoset_id=72157623753329763&format=json&nojsoncallback=1&api_sig=91b24e84c55e34dde1ee56724ca37cfc");
        ...
        {
            flickrData pics = JsonConvert.DeserializeObject<flickrData>(e.Result);
            int n = 0;
            foreach ( Photo pic in pics.photoset.photo)
            {
                ...
                pic.image = baseFlickrUrl;
                pic.owner = pics.photoset.ownername;
                pic.bp = new BitmapImage(new Uri(baseFlickrUrl));
                pic.id = n.ToString();
               
                // FlickrImage is just an Image control in XAML for now
                //FlickrImage.Source = new BitmapImage(new Uri(baseFlickrUrl));
                this.Items.Add(new ItemViewModel() { fd = pic });
                n++;
            }
        }
